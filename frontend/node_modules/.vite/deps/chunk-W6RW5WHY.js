...
var script = {
  ...
  methods: {
    ...
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      l(globalCSS) && BaseStyle.load(globalCSS, _objectSpread({
        name: "global"
      }, this.$styleOptions));
    },
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
      ...
      if (((_this$$theme = this.$theme) === null || _this$$theme === void 0 || (_this$$theme = _this$$theme.options) === null || _this$$theme === void 0 ? void 0 : _this$$theme.cssVariables) === false && (_this$$style0 = this.$style) !== null && _this$$style0 !== void 0 && _this$$style0.name) {
        var added = S.addScopedToken(_defineProperty({}, this.$style.name, preset));
        if (added) {
          S.deleteLoadedStyleName(this.$style.name);
          this._loadThemeStyles();
        }
      }
      var _ref5 = ((_this$$style1 = this.$style) === null || _this$$style1 === void 0 || (_this$$style1$getPres = _this$$style1.getPresetTheme) === null || _this$$style1$getPres === void 0 ? void 0 : _this$$style1$getPres.call(_this$$style1, preset, "[".concat(this.$attrSelector, "]"))) || {}, css = _ref5.css;
      var scopedStyle = (_this$$style10 = this.$style) === null || _this$$style10 === void 0 ? void 0 : _this$$style10.load(css, _objectSpread({
...
//# sourceMappingURL=chunk-W6RW5WHY.js.map
