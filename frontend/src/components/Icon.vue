...
const LIB = {
  ...
  'calendar-alt': {
    paths: ['M8 2v4', 'M16 2v4', 'M3 10h18', 'M6 4H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1', 'M8 14h.01', 'M12 14h.01', 'M16 14h.01', 'M8 18h.01', 'M12 18h.01', 'M16 18h.01'],
  },
  users: {
