...
var FilterService = {
  ...
  filters: {
    startsWith: function startsWith(value, filter2, filterLocale) {
      ...
      var filterValue = ee(filter2.toString()).toLocaleLowerCase(filterLocale);
    ...
    equals: function equals(value, filter2, filterLocale) {
      ...
      else return ee(value.toString()).toLocaleLowerCase(filterLocale) == ee(filter2.toString()).toLocaleLowerCase(filterLocale);
    },
...
//# sourceMappingURL=chunk-6ZILTQV4.js.map
