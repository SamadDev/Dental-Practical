 ...
 */
export declare function useRowClick(onSingleClick: (item: Record<string, unknown>, index: number) => void, onDoubleClick: (item: Record<string, unknown>) => void): {
    handleClick: (item: Record<string, unknown>, index: number) => void;
    handleDblClick: (item: Record<string, unknown>) => void;
};
